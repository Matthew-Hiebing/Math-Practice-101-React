...
export default class Home extends React.Component {
    ...
    componentDidMount() {
        ...
        .then((response) => {
            ...
            tempState.chartData.correctCounter = response.data.correct_answer_count;
            tempState.chartData.incorrectCounter = response.data.incorrect_answer_count;
            tempState.chartData.totalCounter = response.data.total_questions_answered;
